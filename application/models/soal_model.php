...
class Ujian_model extends CI_Model {
    ...
    public function getDataUjian($id)
    {
        ...
        $this->datatables->join('bab b', 'a.bab_id = b.id_bab');
        if($id!==null){
    ...
    public function getListUjian($id, $kelas)
    {
        ...
        $this->datatables->from('m_ujian a');
        $this->datatables->join('bab b', 'a.bab_id = b.id_bab');
        $this->datatables->join('user e', 'e.user_id = c.id');
    ...
    public function getUjianById($id)
    {
        ...
        $this->db->join('bab c', 'a.bab_id=c.id_bab');
    ...
    {
        $this->db->select('id, nama')->from('login')->where('id', $id);
        return $this->db->get()->row();
    }
